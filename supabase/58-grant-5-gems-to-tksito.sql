-- =============================================================================
-- MIGRACIÓN 58: ASIGNACIÓN DE 5 GEMAS AL USUARIO 'TKSITO'
--
-- Asigna:
...
BEGIN
  ...
  WHERE LOWER(TRIM(username)) LIKE '%tksito%'
  LIMIT 1;

  IF NOT FOUND THEN
    RAISE EXCEPTION 'No se encontró ningún usuario con username que contenga "tksito".';
  ELSE
