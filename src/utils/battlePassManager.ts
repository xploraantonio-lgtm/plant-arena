...
export const BATTLE_PASS_LEVELS: PassLevel[] = [
  ...
  },
  {
    ...
    requiredElo: 1300,
    arenaName: 'Jardín Clásico',
    reward: { type: 'copies', plantId: 'sunflower', copiesCount: 3, label: 'x3 Girasol', icon: '/game-assets/greenfoot/transparentsunflower.png' },
  },
  {
    level: 3,
    requiredElo: 1450,
    arenaName: 'Jardín Clásico',
    reward: { type: 'copies', plantId: 'bonkchoy', copiesCount: 3, label: 'x3 Bonk Choy', icon: '/game-assets/greenfoot/bonkchoy1.png' },
  },
  {
    level: 4,
    requiredElo: 1600,
  ...
  },
  {
    ...
    requiredElo: 1900,
    arenaName: 'Desierto Nocturno',
    reward: { type: 'copies', plantId: 'repeater', copiesCount: 3, label: 'x3 Repetidora', icon: '/game-assets/greenfoot/transparentrepeater.png' },
  },
  {
    level: 7,
    requiredElo: 2050,
    arenaName: 'Rascacielos Cyberpunk',
    reward: { type: 'copies', plantId: 'aloe', copiesCount: 3, label: 'x3 Aloe Vera', icon: '/game-assets/plants/aloe_hd.png' },
  },
  {
    level: 8,
    requiredElo: 2200,
    arenaName: 'Rascacielos Cyberpunk',
    reward: { type: 'copies', plantId: 'tallnut', copiesCount: 3, label: 'x3 Nuez Alta', icon: '/game-assets/greenfoot/transparenttallnut.png' },
  },
  {
    level: 9,
    requiredElo: 2350,
  ...
  },
  {
    ...
    requiredElo: 2650,
    arenaName: 'Rascacielos Cyberpunk',
    reward: { type: 'copies', plantId: 'aloe', copiesCount: 4, label: 'x4 Aloe Vera', icon: '/game-assets/plants/aloe_hd.png' },
  },
  {
    level: 12,
    requiredElo: 2800,
    arenaName: 'Rascacielos Cyberpunk',
    reward: { type: 'copies', plantId: 'tallnut', copiesCount: 4, label: 'x4 Nuez Alta', icon: '/game-assets/greenfoot/transparenttallnut.png' },
  },
  {
    level: 13,
    requiredElo: 2950,
  ...
  },
  {
    ...
    reward: { type: 'copies', plantId: 'iceberglettuce', copiesCount: 1, label: 'x1 Lechuga Helada Legendaria', icon: '/game-assets/plants/iceberglettuce_hd.png' },
  },
  {
    level: 15,
    requiredElo: 3250,
  ...
  },
  {
    ...
    requiredElo: 3700,
    arenaName: 'Coliseo Galáctico',
    reward: { type: 'copies', plantId: 'threepeater', copiesCount: 1, label: 'x1 Threepeater Legendario', icon: '/game-assets/greenfoot/threepeater1.png' },
  },
  {
    level: 19,
    requiredElo: 3850,
