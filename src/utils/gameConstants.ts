...
export const PLANT_CONFIGS: Record<PlantId, PlantConfig> = {
  ...
  iceberglettuce: {
    ...
    category: 'defensive',
    damage: 0,
    icon: '/game-assets/plants/iceberglettuce_hd.webp',
    packetActive: '/game-assets/plants/iceberglettuce_hd.webp',
    packetDisabled: '/game-assets/plants/iceberglettuce_hd.webp',
