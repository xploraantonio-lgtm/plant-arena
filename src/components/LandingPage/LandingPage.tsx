...
const PLANTS_DATA: PlantCardData[] = [
  ...
  },
  {
    ...
    rarityInitial: 'PC',
    cost: 50,
    img: '/game-assets/greenfoot/squash1.png',
    hp: 300,
    damage: 600,
    speed: 6.0,
  ...
  },
  {
    ...
    rarityInitial: 'R',
    cost: 125,
    img: '/game-assets/greenfoot/jalapeno1.png',
    damage: 1000,
    range: 'Carril Entero',
  ...
  },
  {
    ...
    rarityInitial: 'E',
    cost: 75,
    img: '/game-assets/greenfoot/aloe_hd.png',
    hp: 300,
    healing: '+150 HP',
  ...
  },
  {
    ...
    rarityInitial: 'L',
    cost: 0,
    img: '/game-assets/greenfoot/iceberglettuce_hd.png',
    freeze: '7 s',
    cooldown: '12 s',
